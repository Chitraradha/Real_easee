...
import 'package:real__ease/View/post/sell/sellpost4.dart';
...
class CreateSellPost3 extends StatefulWidget {
  const CreateSellPost3({super.key});

  @override
  State<CreateSellPost3> createState() => _CreateSellPost3State();
}

class _CreateSellPost3State extends State<CreateSellPost3> {
                                        ...
                                        leading: Radio<PropertyType>(
                                          ...
                                          onChanged: (PropertyType? value) {
                                            setState(() {
                                              ...
                                              post.setPropertyType(_featureNames[value!]!);
                                            });
                                          },
                                        ),
                                      );
